...
qcs_batch_info_data <- extract_qcs_data(rawdata, sample_set_2) #108x121
...
d7_propranolol_data_combat <- cbind(batch_info_columns, d7_propranolol_peak_data) #108x3 
...
# Adding Title
title(main = "No Normalization Dataset (QCS)")
