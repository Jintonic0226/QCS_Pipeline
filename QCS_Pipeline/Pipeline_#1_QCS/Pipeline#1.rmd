...
# Display combined
library(gridExtra)
combined_intensity_plot <- grid.arrange(intensity_plot, intensity_plot_TIC, intensity_plot_IS)
```
:::
...
library(gridExtra)
combined_violin_plot <- grid.arrange(violin_plot_jit, violin_plot_TIC_jit, violin_plot_IS_jit, ncol=2)
```
:::
...
library(gridExtra)
combined_violin_plot_d7 <- grid.arrange(violin_plot_jit_d7, violin_plot_TIC_jit_d7, ncol=2)
```
:::
...
```{r}
library(gridExtra)
# overview_plots <- grid.arrange(combined_intensity_plot, combined_violin_plot, combined_violin_plot_d7)
print(overview_table_pro)
print(overview_table_IS)
```
:::
