...
1.  3 Datasets as csv file (No norm, TIC norm, IS norm) in **Dataset
    folder**
2.  Excel sheets (No norm, TIC norm, IS norm) in **Excel folder**
3.  Overview of Results in **Output folder**
:::
